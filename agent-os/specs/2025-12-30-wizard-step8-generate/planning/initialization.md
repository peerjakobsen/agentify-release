# Wizard Step 8 - Generate

## Initial Idea

Build the final wizard step (Step 8) that orchestrates steering file generation and Kiro handoff.

### From Roadmap Item 24
...
- Checklist with real-time status updates:
  ...
  - [ ] Generate steering files (-> Phase 3, Item 28)
  - [ ] Ready for Kiro
...
- "Generate & Open in Kiro" button - generates then triggers Kiro spec flow (-> Phase 3, Item 34)
...
- Item 28: Kiro Steering Generation (generates `.kiro/steering/` files)
- Item 34: Kiro Spec Trigger (handoff to Kiro spec mode)
- Items 29-33: Agentify Power (installed at project init)

## Context

This is the capstone step of the Ideation Wizard, transforming all the gathered business context, AI-refined assumptions, outcome definitions, security policies, agent designs, mock data strategies, and demo narratives into actionable Kiro steering files.
